...
import { societyPlanHighlights } from "@/lib/plan-content";

export default function SocietyPlanPage() {
  return (
    <div className="mx-auto max-w-4xl px-6 py-16 text-zinc-100">
      ...
      <h1 className="mt-3 text-4xl font-semibold text-white">Society platform plan</h1>
      <p className="mt-4 text-zinc-300">
        This plan defines the layered society model: public discovery, member participation,
        progression systems, and research depth in one connected experience.
      </p>
      <ul className="mt-8 space-y-3 text-zinc-300">
        {societyPlanHighlights.map((item) => (
